    	...
    	<div class="col-md-8 mens_right">
    		<div class="dreamcrub">
			   	<ul class="breadcrumbs">
                    <li class="home">
                       <a href="/reception/show" title="Go to Home Page">Home</a>&nbsp;
                       <span>&gt;</span>
                    </li>
                    <li class="home">&nbsp;
                        Men / Women&nbsp;
                ...
                <ul class="previous">
                	<li><a href="/reception/show">Back to Previous Page</a></li>
                </ul>
                  ...
                  <select>
					...
					<ul>
					  ...
					  <li class="simpleCart_shelfItem">
							<a class="cbp-vm-image" href="/reception/Men4?id=${sult.productPictureId}">
								...
								<div class="product_image">
									...
									<div class="mask">
					                 ...
					                 <div class="product_container">
									   ...
									   <p>Dresses</p>
									   <div class="price mount item_price">${sult.productpresent}</div>
						...
						<c:forEach items="${listv}" var="i">
							<li class="simpleCart_shelfItem">
								<a class="cbp-vm-image" href="/reception/Women3?id=${i.wproductId}&wproductClassId=${i.wproductClassId}&relatedId=${i.related}">
									<div class="view view-first">
										<div class="inner_content clearfix">
											<div class="product_image">
												<div class="mask1"><img
														src="${pageContext.request.contextPath}/images/${i.picturePath}"
														alt="image" class="img-responsive zoom-img"></div>												<div class="mask">
													<div class="info">Quick View</div>
												</div>
												<div class="product_container">
														<%--<h4>Lorem 2015</h4>--%>
													<h4>${i.wproductName}</h4>
													<p>Dresses</p>
													<div class="price mount item_price">$.${i.wproductprice}.00</div>
															<a class="button item_add cbp-vm-icon cbp-vm-add"
															   href="/reception/Women4?wproductName=${i.wproductName}&wproductprice=${i.wproductprice}&picturePath=${i.picturePath}">Add
																to cart</a>
												</div>
											</div>
										</div>
						...
						<li class="last simpleCart_shelfItem">
							<a class="cbp-vm-image" href="/reception/single">
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<div class="mask1"><img src="../images/A_suit/business3.jpg" alt="image" class="img-responsive zoom-img"></div>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li class="simpleCart_shelfItem">
							<a class="cbp-vm-image" href="/reception/single">
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<div class="mask1"><img src="../images/A_suit/business5.jpg" alt="image" class="img-responsive zoom-img"></div>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li class="simpleCart_shelfItem">
							<a class="cbp-vm-image" href="/reception/single">
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<div class="mask1"><img src="../images/A_suit/business7.jpg" alt="image" class="img-responsive zoom-img"></div>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li class="last simpleCart_shelfItem">
							<a class="cbp-vm-image" href="/reception/single">
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<div class="mask1"><img src="../images/A_suit/business9.jpg" alt="image" class="img-responsive zoom-img"></div>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
