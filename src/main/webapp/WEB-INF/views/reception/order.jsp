...
<link href="${pageContext.request.contextPath}/css/orderconfirm.css" rel="stylesheet" />
    <%--<link rel="stylesheet" href="D:\JAVA Project\项目\WristWatchShopping\src\main\webapp\css\tasp.css">
    <link href="D:\JAVA Project\项目\WristWatchShopping\src\main\webapp\css\orderconfirm.css" rel="stylesheet">
--%><style>
#page{width:auto;}
...
<tr class="shop blue-line">
 ...
 target="_blank" title="淘米魅">淘米魅</a>
     <span class="seller"><a href="http://member1.taobao.com/member/user_profile.jhtml?user_id=ac5831c32f47bc9267fcb75b71b5eed6" target="_blank" class="J_MakePoint" data-point-url="http://log.mmstat.com/buy.1.15">淘米魅</a></span>
