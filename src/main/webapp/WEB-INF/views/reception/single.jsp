      ...
      <div class="col-md-9 single_top">
      	<div class="single_left">
			...
			<div class="flexslider">
					 <ul class="slides">
						<li data-thumb="${i.picturePath}">
							<img src="${i.productPictureId}" />
						</li>
		...
		<div class="cont1 span_2_of_a1 simpleCart_shelfItem">
			    ...
			    <div class="price_single">
				  <span class="reducedfrom">$.${i.productprice}.00</span>
				  <span class="amount item_price actual">$.${i.productprice}.00</span><a href="#">click for offer</a>
				</div>
