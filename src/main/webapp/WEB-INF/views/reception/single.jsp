				...
				<div class="single_left">
					<div class="labout span_1_of_a1">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="${pageContext.request.contextPath}/images/${a.productPicture.productPicturePath01}">
									<img src="${pageContext.request.contextPath}/images/${a.picturePath}" />
								</li>
								<li data-thumb="${pageContext.request.contextPath}/images/${a.productPicture.productPicturePath02}">
									<img src="${pageContext.request.contextPath}/images/${a.productPicture.productPicturePath02}" />
								</li>
								<li data-thumb="${pageContext.request.contextPath}/images/${a.productPicture.productPicturePath03}">
									<img src="${pageContext.request.contextPath}/images/${a.productPicture.productPicturePath03}" />
								</li>
								<li data-thumb="${pageContext.request.contextPath}/images/${a.productPicture.productPicturePath04}">
									<img src="${pageContext.request.contextPath}/images/${a.productPicture.productPicturePath04}" />
								</li>
							</ul>
						</div>
					...
					<div class="cont1 span_2_of_a1 simpleCart_shelfItem">
						...
						<div class="price_single">
							<span class="reducedfrom">$.${a.productprice}.00</span>
							<span class="amount item_price actual">$.${a.productpresent}.00</span><a href="#">click for offer</a>
						</div>
						<h2 class="quick">Quick Overview:</h2>
						<p class="quick_desc">${a.productText}</p>
						<div class="wish-list">
							<ul>
						...
						<a href="/reception/Women4?wproductName=${a.productName}&wproductprice=${a.productprice}&picturePath=${a.picturePath}
" class="btn btn-primary btn-normal btn-inline btn_form button item_add item_1" target="_self">Add to cart</a>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="sap_tabs">
			...
			<div class="col-md-3 tabs">
				...
				<c:forEach items="${relatedList}" var="related">
					<ul class="product">
						...
						<li class="product_img"><img src="${pageContext.request.contextPath}/images/${related.kpicturePath}" class="img-responsive" alt=""/></li>
						<li class="product_desc">
								<%--                        <h4><a href="#">quod mazim</a></h4>--%>
							<h4><a href="#">${related.kname}</a></h4>
								<%--                        <p class="single_price">$66.30</p>--%>
							<p class="single_price">$.${related.kprice}.00</p>
							<a href="#" class="link-cart">Add to Wishlist</a>
							<a href="${pageContext.request.contextPath}/reception/addcart?kname=${related.kname}&kprice=${related.kprice}&kpicturePath=${related.kpicturePath}" class="link-cart">Add to Cart</a>
						</li>
						<div class="clearfix"> </div>
					</ul>
				</c:forEach>
...
<div class="footer">
	<div class="container">
		...
		<div class="clearfix"></div>
		<div class="copy">
			<p>Copyright &copy; 2015.Company name All rights reserved.More Templates MaKaBaKa - Collect from </p>
		</div>
	</div>
</div>
<!-- FlexSlider -->
